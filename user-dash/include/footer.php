...
<!-- Copyright Start -->
<div class="container-fluid sticky-top copyright py-4">
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Rout-ing</a> @ <script>
...
<script>
    $(document).ready(function() {
        $('#delete-account-btn').on('click', function() {
            $('.delete-account-confirm').slideDown();
        });
    });
</script>
</body>
