    ...
    <div class="container py-5">
        ...
        <div class="row g-4 mt-4 py-3 shadow-lg ">
            <div class="col-md-4 d-flex justify-content-center align-items-center">
                <!-- <img src="img/features.jpg" alt="User Image" class="profile-image"> -->
                <img src="img/cobb Kaba.jpg" class="rounded-start" style="width: 200px; height: 200px;" alt="Image">
            </div>
            <div class="col-md-8">
                <table class="table table-striped">
                    ...
                    <tr>
                        <th>Phone Number</th>
                        <td>+254 34-567-890</td>
                    </tr>
                    <tr>
                        <th>Birthday</th>
                        <td>14th June 2001</td>
                    </tr>
                </table>
                <button class="btn btn-primary w-100 py-2 mt-4"><i class="fas fa-edit text-secondary me-3"></i>Edit Profile</button>
            </div>
        </div>
